...
import styles from "../styles/herodesigns/marketHero.module.scss"
...
<div className="px-4 container-fluid  d-flex pt-5 pb-4 align-items-center ">
      ...
      <div className="row">
        <div className="col-lg-8 col-md-8 col-sm-12 mt-5 mx-auto">
          ...
          <h1 className="d-none d-lg-block d-md-none d-sm-none d-xs-none ms-5 mx-5 mb-lg-0  " style={{textAlign: "center"}}>
          LOREM IPSUM DOLOR SIT AMET  CONSECTEUR.
		  
          </h1>
			</div>
		  
          <p className="d-none d-lg-block d-md-none d-sm-none d-xs-none ms-4" style={{color: "white", textAlign: "center"}}>
